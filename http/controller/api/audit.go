...
import (
	...
	request "github.com/RobertLesgros/rustdesk-interface/v2/http/request/api"
...
// @Accept  json
// @Produce  json
// @Param body body request.AuditConnForm true "Audit de connexion"
...
// @Accept  json
// @Produce  json
// @Param body body request.AuditFileForm true "Audit de fichier"
// @Success 200 {string} string ""
// @Failure 500 {object} response.Response
